...
|-----------|----------|-------|-------|----------|-----|
| 3d | 0.373 | **0.304** | 0.376 | 0.521 | 0.148 |
| 5d | 0.418 | **0.346** | 0.423 | 0.573 | 0.154 |

### Outright・RV Curve との比較

| 指標 | Outright 3d | RV Curve 3d | RV Butterfly 3d |
|------|------------|-------------|-----------------|
| Global IC | 0.227 | 0.222 | **0.373** |
| **CS IC** | -0.005 | 0.202 | **0.304** |
| TS IC | 0.229 | 0.224 | 0.376 |
| Train IC | 0.519 | 0.469 | 0.521 |
| Gap | 0.292 | 0.246 | **0.148** |

**全指標でバタフライが最高**。特に Gap（過学習の指標）が 0.148 と最小で、汎化性能が高い。
